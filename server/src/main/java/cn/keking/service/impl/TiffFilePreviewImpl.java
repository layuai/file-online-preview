...
public class TiffFilePreviewImpl implements FilePreview {
    ...
    public String filePreviewHandle(String url, Model model, FileAttribute fileAttribute) {
        ...
        String tifName = fileName.substring(0, fileName.lastIndexOf(".") + 1) + "pdf";
        ...
        if ("tif".equalsIgnoreCase(tifPreviewType)) {
            ...
            String inputFileNamePrefix = tifName;
         //   System.out.println(inputFileNamePrefix);
            String strLocalTif;
            // 如果本地不存在这个tif文件，则下载
            ...
            if ("pdf".equalsIgnoreCase(tifPreviewType)) {
                ...
                if (!filePdf.exists()) {
                    filePdf = ConvertPicUtil.convertTif2Pdf(strLocalTif, fileDir + inputFileNamePrefix + ".pdf",url);
                }
                ...
                List<String> listPic2Jpg = ConvertPicUtil.convertTif2Jpg(strLocalTif, strJpgFilePathName,url);
                // 将返回页面的图片url的list对象
