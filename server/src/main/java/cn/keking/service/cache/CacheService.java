...
public interface CacheService {
    ...
    String FILE_PREVIEW_COMPRESS_KEY = "converted-preview-Compress-file";//压缩包内图片文件集合
    ...
    void putCompressCache(String key, List<ZtreeNodeVo> value);
    ...
    Map<String, List<ZtreeNodeVo>> getCompressCache();
    List<ZtreeNodeVo> getCompressCache(String key);
